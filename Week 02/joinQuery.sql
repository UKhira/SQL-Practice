...
-- HCM
SELECT PERIOD_OF_SERVICE_ID,ASSIGNMENT_NUMBER
FROM FUSION.PER_PERIODS_OF_SERVICE 
JOIN FUSION.PER_ALL_ASSIGNMENTS_M
ON FUSION.PER_PERIODS_OF_SERVICE.PERSON_ID = FUSION.PER_ALL_ASSIGNMENTS_M.PERSON_ID

PERSON_ID = 100000003529872